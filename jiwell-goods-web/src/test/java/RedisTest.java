import com.jiwell.JwGoodsWebApplication;
...
@SpringBootTest(classes = JwGoodsWebApplication.class)
...
//    private RedisTemplate<String, String> redisTemplate;
    ...
    private static final String KEY_PREFIX = "jiwell:seckill:test";
...
//        redisTemplate.opsForValue().increment("key",1);
    ...
    @Test
    public void test(){
//        BoundHashOperations<String,Object,Long> hashOperations = this.stringRedisTemplate.boundHashOps("jiwell:goods:detail:1");
//        BoundValueOperations<String, String> valueOperations = this.stringRedisTemplate.boundValueOps("jiwell:goods:detail:1");
