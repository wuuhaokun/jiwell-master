package com.jiwell.service.impl;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.jiwell.client.BrandClient;
import com.jiwell.client.CategoryClient;
import com.jiwell.client.GoodsClient;
import com.jiwell.client.SpecClient;
import com.jiwell.item.bo.SpuBo;
import com.jiwell.item.pojo.*;
import com.jiwell.repository.GoodsRepository;
import com.jiwell.service.SearchService;
...
public class SearchServiceImpl implements SearchService {
    ...
    public Goods buildGoods(Spu spu) throws IOException {
        ...
        skus.forEach(sku -> {
            ...
            skuMap.put("lastUpdateTime",sku.getLastUpdateTime());
